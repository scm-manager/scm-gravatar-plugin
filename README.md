...
The gravatar plugin adds Gravatar icons for SCM-Manager.

## Usage

Find out how this plugin can be used on the [user documentation page](https://scm-manager.org/plugins/scm-gravatar-plugin/docs).
